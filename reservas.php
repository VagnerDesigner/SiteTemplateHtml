<?php
	...
	$conexao = mysqli_connect("localhost","root","","bd_reservas");
	...
	$cadastro = "insert into tb_reservas (nomePacote,nome,telefone,entrada,saida,email) values ('$nomePacote','$nome','$telefone','$entrada','$saida','$email')";
	$salvar   = mysqli_query($conexao,$cadastro);
